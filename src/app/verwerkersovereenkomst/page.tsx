  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12">
        <h1 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-2">Verwerkersovereenkomst</h1>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">Partijen</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">1. Onderwerp en duur</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">2. Aard en doel van de verwerking</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">3. Instructies van de Klant</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">4. Vertrouwelijkheid</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">5. Beveiligingsmaatregelen</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-2">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">6. Sub-verwerkers</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">7. Doorgifte buiten de EER</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">8. Datalekken</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">9. Rechten van betrokkenen</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">10. Audit-recht</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">11. Beëindiging</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">12. Aansprakelijkheid</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-slate-100 mb-3">13. Toepasselijk recht</h2>
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">

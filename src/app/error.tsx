  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-2xl mx-auto px-6 py-24 text-center">
        ...
        {error.digest && (
          <p className="text-xs text-slate-400 font-mono mb-8">Foutcode: {error.digest}</p>
        )}
        <div className="flex items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 border border-slate-200 hover:border-slate-300 text-slate-700 px-5 py-2.5 rounded-lg font-medium transition"
          >
